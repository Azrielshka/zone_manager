...
### 📁 Вручную
1. Скопировать интеграцию: /config/custom_components/zone_manager
2. Скопировать карточку: /config/www/zone-manager-card-v0.3.1.js
...
Основной конфиг расположен здесь: /config/zones_config.json
